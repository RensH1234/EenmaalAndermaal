        ...
        <div class="carousel-inner ">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    ...
                    <a class="btn btn-outline-light btn-lg" href="VeilingenOverzicht.php">Bekijk veilingen!</a>
                    <a class="btn btn-primary btn-lg test" href="RegistratieOpgeven.php">Registreer nu!</a>
                </div>
            </div>
