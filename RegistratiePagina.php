                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="inputGroupContainer">
                                        <div class="input-group">
                                            <input  required name="gebruikersnaam" placeholder="Gebruikersnaam" class="form-control"  type="text" value=$gebruikersnaam>*
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-1">
                                <div class="form-group">
                                    ...
                                    <div class="inputGroupContainer">
                                        <div class="input-group">
                                            <input  required name="wachtwoord" placeholder="Wachtwoord" class="form-control"  type="password" value=$wachtoord1>*
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-1">
                                <div class="form-group">
                                    ...
                                    <div class="inputGroupContainer">
                                        <div class="input-group">
                                            <input  required name="wachtwoord_herhaling" placeholder="Herhaal wachtwoord" class="form-control"  type="password" value=$wachtwoord2>*
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-xs-1">
                                <div class="form-group">
                                    ...
                                    <div class="inputGroupContainer">
                                        <div class="input-group">
                                            <input  required name="voornaam" placeholder="Voornaam" class="form-control"  type="text" value=$voornaam>*
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-1">
                                <div class="form-group">
                                    ...
                                    <div class=" inputGroupContainer">
                                        <div class="input-group">
                                            <input  required name="achternaam" placeholder="Achternaam" class="form-control"  type="text"  value=$achternaam>*
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-1">
                            <div class="form-group">
                                ...
                                <div class="inputGroupContainer">
                                    <div class="input-group">
                                        <input  required name="straatnaam" placeholder="Straatnaam" class="form-control"  type="text" value=$straatnaam>*
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4 col-xs-1">
                            <div class="form-group">
                                ...
                                <div class="inputGroupContainer">
                                    <div class="input-group">
                                        <input  required name="huisnummer" placeholder="Huisnummer" class="form-control"  type="text" value=$huisnummer>*
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-1">
                            <div class="form-group">
                                ...
                                <div class="inputGroupContainer">
                                    <div class="input-group">
                                        <input  required name="postcode" placeholder="Postcode" class="form-control"  type="text" value=$postcode>*
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 col-xs-1">
                            <div class="form-group">
                                ...
                                <div class="inputGroupContainer">
                                    <div class="input-group">
                                        <input  required name="plaatsnaam" placeholder="Plaatsnaam" class="form-control"  type="text" value=$plaatsnaam>*
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 col-xs-1">
                            <div class="form-group">
                                ...
                                <div class="inputGroupContainer">
                                    <div class="input-group">
                                        <input  required name="land" placeholder="Land" class="form-control"  type="text" value=$land>*
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-1">
                            <div class="form-group">
                                ...
                                <div class="inputGroupContainer">
                                    <div class="input-group">
                                        <input  required name="geboortedatum" placeholder="" class="form-control"  type="date" value=$geboortedatum>*
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-xs-1">
                            <div class="form-group">
                                ...
                                <div class="inputGroupContainer">
                                    <div class="input-group">
                                        <input  required name="antwoord" placeholder="Antwoord beveiligingsvraag" class="form-control"  type="text" value=$aBeveiligingsvraag>*
                                    </div>
                                </div>
                            </div>
                        </div>
